...
public class AccountSignupFacebook {
  ...
  @Test
	public void NewAccountSignup () throws MalformedURLException {
	  try {
		...
		new WebDriverWait(driver, 30).until(ExpectedConditions.presenceOfElementLocated(By.xpath("(//div[@data-pp-auto-id='Login'])")));
		driver.findElement(By.xpath("(//div[@data-pp-auto-id='Login'])")).click();

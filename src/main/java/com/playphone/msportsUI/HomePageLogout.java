	 ...
	 // private String baseUrl;
	  ...
	  public void TestValidLogin () throws MalformedURLException {
		  ...
		  try {
		    ...
		    new WebDriverWait(driver, 30).until(ExpectedConditions.presenceOfElementLocated(By.xpath("//a[@data-pp-auto-id='logout']")));
			driver.findElement(By.xpath("//a[@data-pp-auto-id='logout']")).click();
			try {
	            Thread.sleep(3000);
	        } catch (InterruptedException e) {
	            e.printStackTrace();

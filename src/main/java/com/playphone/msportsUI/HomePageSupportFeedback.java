...
public class HomePageSupportFeedback {
	...
	@Test
	  public void SupportFeedback () throws MalformedURLException {
		  ...
		  try {
		    ...
		    new WebDriverWait(driver, 60).until(ExpectedConditions.presenceOfElementLocated(By.xpath("(//div[@data-pp-auto-id='gotoFeedback'])")));
		    driver.findElement(By.xpath("(//div[@data-pp-auto-id='gotoFeedback'])")).click();
		    try {
	            Thread.sleep(3000);
	        } catch (InterruptedException e) {
	            e.printStackTrace();

	 ...
	 // private String baseUrl;
	  ...
	  public void TestValidLogin () throws MalformedURLException {
		  ...
		  try {
		    ...
		    new WebDriverWait(driver, 30).until(ExpectedConditions.presenceOfElementLocated(By.xpath("//a[@data-pp-auto-id='games']")));
		    driver.findElement(By.xpath("//button[@data-pp-auto-id='games']")).click();
		    new WebDriverWait(driver, 30).until(ExpectedConditions.presenceOfElementLocated(By.xpath("//button[@data-pp-auto-id='icon-msports-close']")));
		    driver.findElement(By.xpath("//button[@data-pp-auto-id='icon-msports-close']")).click();

...
public class HomePageSupportTC {
	...
	@Test
	  public void SupportTC () throws MalformedURLException {
		  ...
		  try {
		    ...
		    new WebDriverWait(driver, 60).until(ExpectedConditions.presenceOfElementLocated(By.xpath("(//div[@data-pp-auto-id='gotoTerms'])")));
		    driver.findElement(By.xpath("(//div[@data-pp-auto-id='gotoTerms'])")).click();
		    try {
	            Thread.sleep(3000);
	        } catch (InterruptedException e) {
	            e.printStackTrace();

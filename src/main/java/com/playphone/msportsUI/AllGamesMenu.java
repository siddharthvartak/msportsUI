	 ...
	 // private String baseUrl;
	  ...
	  public void TestValidLogin () throws MalformedURLException {
		  ...
		  try {
		    ...
		    new WebDriverWait(driver, 20).until(ExpectedConditions.presenceOfElementLocated(By.xpath("//a[@data-pp-auto-id='games']")));
		    driver.findElement(By.xpath("//a[@data-pp-auto-id='games']")).click();

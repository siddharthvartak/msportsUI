...
public class ChangePassword {
	...
	public void NewAccountSignup() throws MalformedURLException {
		...
		new WebDriverWait(driver, 30)
				.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//div[@data-pp-auto-id='skip']")));
		...
		new WebDriverWait(driver, 60).until(ExpectedConditions
				.presenceOfElementLocated(By.xpath("(//button[@data-pp-auto-id='floater-signup-button'])")));
		...
		// 30).until(ExpectedConditions.presenceOfElementLocated(By.xpath("(//div[@id='account']/ng-component/div/div/div[6]/div/span[2]")));
		...
		new WebDriverWait(driver, 60).until(
				ExpectedConditions.presenceOfElementLocated(By.xpath("//div[@data-pp-auto-id='sign-with-email']")));
		...
		new WebDriverWait(driver, 20).until(
				ExpectedConditions.presenceOfElementLocated(By.xpath("//a[@data-pp-auto-id='nav-bar-user-avatar']")));
		...
		new WebDriverWait(driver, 30).until(ExpectedConditions.presenceOfElementLocated(By.xpath("//a[@data-pp-auto-id='msports-change-password-icon']")));
		driver.findElement(By.xpath("//a[@data-pp-auto-id='msports-change-password-password-icon']")).click();
		try {
			Thread.sleep(4000);
		} catch (InterruptedException e) {
			e.printStackTrace();
		}
		driver.findElement(By.xpath("//input[@data-pp-auto-id='myprofile-current-password']")).clear();
		driver.findElement(By.xpath("//input[@data-pp-auto-id='myprofile-current-password']")).sendKeys("test1234");
		try {
			Thread.sleep(3000);
		} catch (InterruptedException e) {
			e.printStackTrace();
		...
		driver.findElement(By.xpath("//input[@data-pp-auto-id='password-input-field']")).sendKeys("test12345");
		try {
			Thread.sleep(3000);
		} catch (InterruptedException e) {
			e.printStackTrace();
		}
		driver.findElement(By.xpath("//input[@data-pp-auto-id='confirmPassword-input-field']")).clear();
		driver.findElement(By.xpath("//input[@data-pp-auto-id='confirmPassword-input-field']")).sendKeys("test12345");
		try {
			Thread.sleep(3000);
		} catch (InterruptedException e) {
			e.printStackTrace();
		}
		new WebDriverWait(driver, 20).until(ExpectedConditions.presenceOfElementLocated(By.xpath(".//*[@id='my-profile-change-password']/section[2]")));
		driver.findElement(By.xpath(".//*[@id='my-profile-change-password']/section[2]")).click();
		try {
			Thread.sleep(4000);
		} catch (InterruptedException e) {
			e.printStackTrace();

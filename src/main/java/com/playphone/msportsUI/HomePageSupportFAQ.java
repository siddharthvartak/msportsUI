...
public class HomePageSupportFAQ {
	...
	@Test
	  public void SupportFAQ () throws MalformedURLException {
		  ...
		  try {
		    ...
		    new WebDriverWait(driver, 30).until(ExpectedConditions.presenceOfElementLocated(By.xpath("(//a[@data-pp-auto-id='gotoSupportsPage'])")));
		    ...
		    new WebDriverWait(driver, 30).until(ExpectedConditions.presenceOfElementLocated(By.xpath("(//div[@data-pp-auto-id='gotoFAQ'])")));
		    driver.findElement(By.xpath("(//div[@data-pp-auto-id='gotoFAQ'])")).click();
		    try {
	            Thread.sleep(3000);
	        } catch (InterruptedException e) {
	            e.printStackTrace();

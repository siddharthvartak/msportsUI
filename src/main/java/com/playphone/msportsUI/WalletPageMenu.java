	 ...
	 // private String baseUrl;
	  ...
	  public void TestValidLogin () throws MalformedURLException {
		  ...
		  try {
		    ...
		    new WebDriverWait(driver, 20).until(ExpectedConditions.presenceOfElementLocated(By.xpath("//div[@data-pp-auto-id='outer-menu-button']")));
		    ...
		    new WebDriverWait(driver, 20).until(ExpectedConditions.presenceOfElementLocated(By.xpath("//div[@data-pp-auto-id='mega-jackpot']")));
		    driver.findElement(By.xpath("//div[@data-pp-auto-id='mega-jackpot']")).click();

...
public class HttpGetterXML {

	
	
	public static void main(String[] args) throws Exception {
		 
	    String sXML = HttpGetterXML
	            .getDoc("https://sdk.o01.dev.playphone.cc/sdk/discover/tournaments/873ac720-2d43-4987-9528-187032c60e65/0/100?format=Ranking");
	 
	    Document dom = HttpGetterXML.loadXMLFromString(sXML);
	 
	    Element el = (Element) dom.getDocumentElement();
	 
	    System.out.println(HttpGetterXML.getTextValue(el, "game_id"));
	    System.out.println(HttpGetterXML.getTextValue(el, "tournament_id"));
